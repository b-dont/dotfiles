...
$env.config = {
  ...
  # true or false to true or false the welcome banner at startup
  show_banner: false
  ls: {
    use_ls_colors: false # use the LS_COLORS environment variable to colorize output
    clickable_links: true # true or false clickable links. Your terminal has to support links.
  }
  rm: {
  ...
  history: {
    ...
    # history_isolation: true # true trues history isolation, false falses it. true will allow the history to be isolated to the current session. false will allow the history to be shared across all sessions.
  }
  completions: {
    case_sensitive: false # set to true to true case-sensitive completions
  ...
  bracketed_paste: true # true bracketed paste, currently useless on windows
  ...
  render_right_prompt_on_last_line: false # true or false to true or false right prompt to be rendered on last line of the prompt.
